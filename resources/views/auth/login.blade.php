...
<head>
    ...
    <title>Login Page - SMARTPH</title>
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title" style="text-align: center">Welcome to SMART PH ! 👋</h4>
                                <form class="auth-login-form" action="{{ route('login') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-info btn-block" tabindex="4">Sign
                                        in</button>
                                </form>
