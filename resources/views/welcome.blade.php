...
<body">
  <header id="header">
    <div class="container">
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">SmartpH</a></h1>
      </div>
  ...
  <section id="intro">
    <div class="intro-text">
      <h2>Selamat datang di SmartpH</h2>
      <p>Proyek Internet of Things Monitoring PH dan Control Berbasis Web</p>
      <a href="{{route('login')}}" class="btn-get-started scrollto">Login</a>
    </div>
    <div class="product-screens">
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="{{asset('template1/landing/img/monitoring.png')}}" alt="">
      </div>
      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="{{asset('template1/landing/img/grafik.png')}}" alt="">
      </div>
      <div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
        <img src="{{asset('template1/landing/img/about.png')}}" alt="">
      </div>
    </div>
  </section>
  <main id="main">
      ...
      <div class="container">
        <div class="row wow fadeInUp">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="info">
              <div>
                ...
                <p>Kampung Kelor <br>RT 003 RW 003 Kampung Kelor, Sepatan Timur  <br> Tangerang Regency, Banten 15520 </p>
              </div>
              <div>
         ...
         <div class="col-lg-5 col-md-5">
          <iframe src="https://maps.google.com/maps?width=548&amp;height=353&amp;hl=en&amp;q=TheMagic&amp;t=p&amp;z=18&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 text-lg-left text-center">
          <div class="copyright">
            &copy; Copyright <strong><a href="http://laurensius-dede-suhardiman.com/" target="_blank">Abdul Rohman</a></strong>.
          </div>
          <div class="credits">
